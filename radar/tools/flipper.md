...
Flipper is built around a plugin system which allows developers to create custom plugins for a variety of use cases. A list of available plugins can be downloaded directly from Flipper.
