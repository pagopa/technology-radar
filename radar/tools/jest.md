...
We choose to hold Jest because we are currently using it in our projects, but we are evaluating other testing frameworks like Vitest. Vitest offers Typescript support out of the box, and it's a good fit for our projects, while Jest requires some additional configuration (ie. ts-jest, etc.).
