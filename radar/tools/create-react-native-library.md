...
[create-react-native-library](https://callstack.github.io/react-native-builder-bob/) is a CLI for scaffolding React Native libraries for iOS and Android. It simplifies the process of creating, building, testing, and publishing React Native libraries by providing a CLI that leverages `react-native-builder-bob`.
...
6. **Multi-language support**: Supports the creation of libraries written in Swift, Kotlin, Java, Objective-C and C++.
