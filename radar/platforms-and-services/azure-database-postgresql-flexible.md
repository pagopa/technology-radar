...
[Azure Database for PostgreSQL - Flexible Server](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/overview) is a fully managed database service designed to provide more granular control and flexibility over database management functions and configuration settings compared to the Single Server deployment model. It offers better cost optimization options, high availability within the same zone and across zones, and customer-managed maintenance windows.

## Use cases

Ideal for production workloads requiring a PostgreSQL database with high availability, granular control over server configuration, and cost optimization. Suitable for new applications or migrating from Single Server or on-premises instances.

## Reference of usage in our organization

Several existing databases have been successfully migrated from Single Server to Flexible Server, including:
