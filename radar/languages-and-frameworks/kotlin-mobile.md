...
- Kotlin is currently the preferred language for [Android development](https://developer.android.com/kotlin).
- Kotlin Multiplatform has become [stable](https://kotlinlang.org/docs/components-stability.html#stability-of-subcomponents) and used for [cross-platform development](https://kotlinlang.org/docs/multiplatform.html).
